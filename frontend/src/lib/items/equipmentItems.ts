...
const RAW_ITEM_DEFINITIONS: Record<ItemId, ItemDefinition> = {
  magic_hat: {
    id: 'magic_hat',
    type: 'equipment',
    name: 'Magic Hat',
    ...
    textureKey: 'item-magic-hat',
    texturePath: '/items/equipment/magic-hat.png',
    socketCount: 1,
    equippedOffsetX: 0,
    equippedOffsetY: -4,
  },
  robe_tunic: {
    ...
    textureKey: 'item-robe-tunic',
    texturePath: '/items/equipment/robe-tunic-8x8.png',
    socketCount: 2,
    equippedOffsetX: 0,
    equippedOffsetY: 0,
  },
